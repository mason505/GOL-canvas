...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Gol = __webpack_require__(159);
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_Gol2.default, null)
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var grid = [[1, 0, 1], [1, 1, 1], [1, 0, 0], [1, 0, 0], [1, 0, 0]];

	var makeGrid = function makeGrid(num) {
	    var g = [];
	...
	exports.default = _react2.default.createClass({
	    ...
	    componentDidMount: function componentDidMount() {
	        ...
	        var baseScale = 3;
	        var diagLen = Math.sqrt(this.props.height * this.props.height + this.props.width * this.props.width);
	        var ytranslate = diagLen - this.props.height;
